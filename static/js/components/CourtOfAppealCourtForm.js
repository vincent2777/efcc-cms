    ...
    <>
      ...
      <Flex alignItems={"start"}>
        ...
        >
          ...
          <Flex direction={"column"} justify={"flex-end"}>
            <FormLabel>Appeal division</FormLabel>
            <Input isRequired placeholder="Enter here" />
          </Flex>
          <Flex direction={"column"} justify={"flex-end"}>
            <FormLabel>Panel of judges</FormLabel>
            <Input isRequired placeholder="Enter here" />
          </Flex>
          <Flex direction={"column"} justify={"flex-end"}>
          ...
          <Flex direction={"column"} justify={"flex-end"}>
            <FormLabel>Date judgement was delivered </FormLabel>
            <Input isRequired placeholder="Enter here" />
          </Flex>
          <Flex direction={"column"} justify={"flex-end"}>
          ...
          <Flex direction={"column"} justify={"flex-end"}>
            <FormLabel>Is this is high profile case?</FormLabel>
            <Input isRequired placeholder="Enter here" />
          </Flex>
          <Flex direction={"column"} justify={"flex-end"}>
          ...
          <Flex direction={"column"} justify={"flex-end"}>
            <FormLabel>Appeal initiated by commission / others</FormLabel>
            <Input isRequired placeholder="Enter here" />
          </Flex>
          <Flex direction={"column"} justify={"flex-end"}>
...
export default CourtOfAppealCourtForm;
